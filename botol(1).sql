...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Nov 2024 pada 10.30
...
INSERT INTO `assets` (`id`, `nama_asset`, `merk_kode`, `qty`, `ok`, `status`, `barcode`, `kategori`) VALUES
(111, 'Monitor LG 24MP59G', 'LG', 1, NULL, 1, 'LG_4040544509', 'Monitor'),
(112, 'Printer HP LaserJet Pro M404n', 'HP', 1, NULL, 0, 'HP_9204536166', 'Printer'),
(113, 'Keyboard Logitech K120', 'Logitech', 1, NULL, 1, 'Logitech_2103885588', 'Keyboard'),
(114, 'Mouse Razer DeathAdder Elite', 'Razer', 1, NULL, 1, '', 'Mouse'),
(115, 'External Hard Drive Seagate 1TB', 'Seagate', 1, NULL, 0, 'Seagate_5089970782', 'External Hard Drive'),
(116, 'SSD Samsung 970 EVO Plus 500GB', 'Samsung', 1, NULL, 1, '', 'SSD'),
(117, 'Webcam Logitech C920', 'Logitech', 1, NULL, 0, '', 'Webcam'),
(118, 'UPS APC Back-UPS Pro 1500VA', 'APC', 1, NULL, 1, '', 'UPS'),
(119, 'Router Wi-Fi TP-Link Archer A7', 'TP-Link', 1, NULL, 1, 'TP-', 'Router'),
(120, 'Switch Cisco Catalyst 9200', 'Cisco', 1, NULL, 1, '', 'Switch');
