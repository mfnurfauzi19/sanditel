                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('fullname'); ?>" name="fullname" id="fullname" type="text" class="form-control" placeholder="Nama Customer..." autofocus>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('phone'); ?>" name="phone" id="phone" type="text" class="form-control" placeholder="Nomor Telepon...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <textarea name="address" id="address" class="form-control" rows="4" placeholder="Divisi...."><?= set_value('address'); ?></textarea>
                        </div>
